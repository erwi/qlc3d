...
////void assemble_volume(const Coordinates &coordinates,
//                     SolutionVector *v,
//                     SolutionVector *q,
//                     const LC &lc,
//                     Mesh *mesh,
...
//void assemble_Neumann(const Coordinates &coordinates,
//                      SolutionVector *v,
//                      SolutionVector *q,
//                      const LC &lc,
//                      Mesh *mesh,
...
// DECLARATION ONLY
void setUniformEField(Electrodes &electrodes, SolutionVector &v, const Coordinates &coordinates);
...
void calcpot3d(
    ...
    // Assemble system
    assemble_volume(geom, v, q, lc, K , L, electrodes);
    assemble_Neumann(geom.getCoordinates() , v , q , lc , geom.t.get() , geom.e.get() , K , L);
//#ifdef DEBUG
