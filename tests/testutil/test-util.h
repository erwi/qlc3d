...
namespace TestUtil {
  ...
  const std::string RESOURCE_THIN_QUADRATIC_GMSH_MESH = "resources/mesh1d-periodic-quadratic.msh";
  ...
  const std::string RESOURCE_PSEUDO_2D_NEUMANN_QUADRATIC_GMSH_MESH = "resources/pseudo-2d-neumann-quadratic.msh";
